...
Pool.prototype.get = function(x,y,angle, size, speed, type, camera, nodeID) {

  if(this.freeElements.length === 0){
    this.grow();
  }

  this.elements[ this.freeElements.head.data ].init(x, y, angle, size, speed, type, camera, nodeID);
